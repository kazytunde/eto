...
March 13, 2019 · Justin Mitchel

This is the first post of a many part Linux/Ubuntu deployment series. Check back for more.
...
use PowerShell or possibly PuTTY (for SSH). This guide might not work for your version Windows too. :()
Live Server Details
...
Download and install via https://git-scm.com/downloads
